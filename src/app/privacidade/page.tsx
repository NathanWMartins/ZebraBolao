        ...
        <Box sx={{ minHeight: '100vh', bgcolor: '#111110', backgroundImage: 'repeating-linear-gradient(-55deg, transparent, transparent 18px, rgba(255,255,255,0.03) 18px, rgba(255,255,255,0.03) 36px)' }}>
            ...
            <Container maxWidth="md" sx={{ py: { xs: 5, md: 8 }, px: { xs: 3, md: 4 } }}>
                ...
                <Section number="1" title="Introdução">
                    ...
                    <P>Caso não concorde com os termos aqui descritos, solicitamos que não utilize o Serviço. Para dúvidas, entre em contato pelo e-mail indicado na seção 12.</P>
                </Section>
                ...
                <Section number="2" title="Dados Pessoais Coletados">
                    ...
                    <SubTitle>a) Dados fornecidos via autenticação (Google OAuth ou e-mail/senha)</SubTitle>
                    <BulletList items={[
                        'Nome completo ou nome de usuário',
                        'Endereço de e-mail',
                        'Foto de perfil (quando fornecida via Google)',
                ...
                <Section number="5" title="Compartilhamento de Dados">
                    <P>Não vendemos nem comercializamos seus dados pessoais. O compartilhamento ocorre apenas com prestadores de serviço essenciais:</P>
                    <BulletList items={[
                        'Supabase Inc. — infraestrutura de banco de dados e autenticação',
                        'Google LLC — autenticação OAuth (quando utilizada)',
                ...
                <Section number="7" title="Retenção e Exclusão de Dados">
                    ...
                    <P>Para solicitar a exclusão, entre em contato pelo e-mail da seção 12.</P>
                </Section>
                ...
                <Section number="8" title="Segurança dos Dados">
                    ...
                    <BulletList items={[
                        'Autenticação via OAuth 2.0 ou e-mail/senha com hash seguro (bcrypt)',
                ...
                <Section number="9" title="Seus Direitos como Titular dos Dados">
                    ...
                    <P>Para exercer qualquer um desses direitos, entre em contato pelo e-mail da seção 12. Responderemos em até 15 dias úteis.</P>
                </Section>

                <Section number="10" title="Cookies">
                    <P>
                        Utilizamos apenas cookies essenciais para o funcionamento do Serviço, como manutenção
                        da sessão autenticada. Não utilizamos cookies de publicidade ou rastreamento de terceiros.
                    </P>
                </Section>
                ...
                <Section number="11" title="Menores de Idade">
                    <P>
                        ...
                        uma conta, excluiremos seus dados imediatamente.
                    </P>
                </Section>
                ...
                <Section number="12" title="Contato">
                    ...
                    <P>
                        ...
                        <ExternalLink href="https://www.gov.br/anpd">Autoridade Nacional de Proteção de Dados (ANPD)</ExternalLink>.
                    </P>
                </Section>
